...
<body class="grid_container">
    ...
    <aside class="sidebar">
        ...
        <div class="sidebar_menu">
            ...
            <li class="botones_sidebar"><a class="a" href="inicio.php"><img class="iconos_sidebar" src="../PagInicio/Recursos/iconos/Inicio.svg" alt=""> Inicio</a></li>
                ...
                <li class="botones_sidebar"><a class="a" href="entregados.php" style="background-color: #5a5a9c"><img class="iconos_sidebar" src="../PagInicio/Recursos/iconos/Publicaciones_Entregadas.svg" alt=""> Entregados</a></li>
    ...
    <div class="main"> 
        <?php
            ...
            $consultaEntregado = $conn->prepare("SELECT id_cons FROM entregado WHERE id_us = '".$_SESSION['id_us']."'");
                        ...
                        ';
                            echo'
                                <div class="postularDiv">
                                    <input value="Finalizado" type="submit" class="postularBtn" name="verPostulantes" style="background-color:#5050ac">
                                </div>
                            ';
                        }
                        echo'
